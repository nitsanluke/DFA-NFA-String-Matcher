...
public class nfa extends javax.swing.JFrame implements TableModelListener {
    ...
    public void sendInput(int states, String inputSymbols) {
        this.states = states;
        this.inputSymbols = inputSymbols+"E";

        columnNames = new String[(inputSymbols.length() + 2)];
        data = new Object[(states)][(inputSymbols.length() + 2)];
        char[] charArray = inputSymbols.toCharArray();

        columnNames[0] = " States ";
        columnNames[columnNames.length-1] = " Epsilon(E) ";
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(finiteautomata.FiniteAutomataApp.class).getContext().getResourceMap(nfa.class);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {
        ...
        // graph.generateGraph();
        tGraph g = new tGraph();
        g.sendData("nfa", inputSymbols, data, jTextField1.getText(), jTextField2.getText());
        g.genGraph();
